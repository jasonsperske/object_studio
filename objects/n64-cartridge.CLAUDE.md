...
Use `n64-cartridge` for nintendo 64 cartridge props from the cartridge era. Geometry is in millimetres,
...
Available shell variants: North American rear keys, Japanese rear keys.
...
| `variant` | select | `standard`, `japan` | `"standard"` | Only used in some combinations. |
