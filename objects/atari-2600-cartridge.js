// Atari 2600 cartridge. Dimensions are approximate visual references in millimetres.
// +Y up, front +Z. Media slots are returned on parts, never in parameters.
export const meta = {
  "name": "Atari 2600 cartridge",
  "description": "Blank-label atari 2600 cartridge with a boxed copy, separate shell halves, PCB and family-specific moulding.",
  "order": 30
}
const profile = {"family": "atari", "width": 81, "height": 87, "depth": 19, "color": 2697258, "pins": 12, "screws": 1, "box": [140, 190, 25]}
export const params = [
  {
    "id": "presentation",
    "label": "Presentation",
